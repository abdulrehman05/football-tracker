...
export const playerRules: PlayerRule[] = [
  ...
  (player, matches) => {
    ...
    if (totals.goals === 0 && totals.shots >= 12) {
      return [
        {
      ...
      return [
        {
          ...
          importance: 5 + playedAgainst * 0.5,
        },
      ];
    }
    return [];
